            ...
            <div class="container">
                ...
                <div class="header-right-wrapper">
                    ...
                    <nav id="site-navigation" class="main-navigation" role="navigation">
                        <ul class="onepress-menu"><!-- menu-item menu-item-type-post_type menu-item-object-page menu-item-home
...
if ( ! function_exists( 'onepress_posted_on' ) ) {
    ...
    function onepress_posted_on()
    {
        ...
        $posted_on = sprintf(
            esc_html_x('Le %s', 'post date', 'onepress'),
            $time_string
        );

        $byline = sprintf(
            esc_html_x('Par %s', 'post author', 'onepress'),
...
if ( ! function_exists( 'onepress_footer_site_info' ) ) {
    ...
    function onepress_footer_site_info()
    {
        ...
        <?php printf(esc_html__('Copyright %1$s %2$s - David EVAN', 'onepress'), '&copy;', esc_attr(date('Y')));?>
        </span>
        <?php
    }
}
